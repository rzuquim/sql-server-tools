...
;WITH missing_indexes AS (
  SELECT  [database] = db_name(mid.database_id),
          [object_name] = Object_name(mid.object_id, mid.database_id),
...
SELECT *, probable_cost = (total_cost - (total_cost * (avg_user_impact/100)))
